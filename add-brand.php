...
if($_POST)
{
    ...
    $query = mysqli_query($connection,"insert into tbl_brand(brand_name) values('{$brand_name}') ") or die(mysqli_error($connection));
                ...
                <div class="card-body">
                  <form method="post" enctype="multipart/form-data" id="myform">
                    <div class="mb-3">
                      ...
                      <input type="text" required class="form-control" name="brand_name" placeholder="Enter Brand Name" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>                 
