...
if($_POST)
{
    ...
    $query = mysqli_query($connection,"insert into tbl_user(user_name,email_id,password) values('{$name}','{$email}','{$password}') ") or die(mysqli_error($connection));
}
if($query)
{
              ...
              <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" id="myform">
                 <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputtext1" name="uname" aria-describedby="textHelp">
                 </div>
                 <div class="mb-3">
