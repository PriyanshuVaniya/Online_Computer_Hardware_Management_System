  ...
  #w3lDemoBar.w3l-demo-bar .no-margin-bottom-mobile{
	...
	<div class="page-head_agile_info_w3l inner-checkout-page">
		<div class="container py-5">
			<h3 class="title-style text-white pt-5"><span>View</span> Order Details</h3>
		</div>
	</div>
	<!-- //banner-2 -->
	<!-- page -->
			...
			<div class="checkout-right">
				<div class="table-responsive">
					<table class="timetable_sub">
						...
						<tbody>
							<?php
 $q = mysqli_query($connection,"select * from tbl_orderdetail where order_id ='{$_GET['order_id']}'");
 while($row=mysqli_fetch_array($q))
 {
    ...
    $pdata = mysqli_fetch_array($pq);
							...
							<tr class="rem1">
                                ...
                                <td>
                                <img src="upload/<?php echo $pdata["image_path"];?>" class="img-responsive" height="50px">
