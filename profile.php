	...
	<div class="page-head_agile_info_w3l inner-contact-page">
		<div class="container py-5">
			...
			<ul class="w3_short pt-3 pb-5">
				...
				<li class="text-light">My Profile</li>
			</ul>
		</div>
	</div>
	<!-- //banner-2 -->
			...
			<div class="mx-auto pt-lg-4 pt-md-5 pt-4" style="max-width:1000px">
				<div class="row contact-block">
					<div class="col-md-5 contact-left">
						<h3 class="title-style font-weight-bold mb-4">Profile</h3>
					...
					<div class="col-md-7 contact-right mt-md-0 mt-4">
						...
						<form action="#" id="myform" method="post" id="myform" class="signin-form">
							<div class="input-grids">
								NAME: <input type="text" name="w3lName" value="<?php echo $row["user_name"]; ?>"  class="contact-input" readonly />
								GENDER: <br>
                                male:<input type="radio"   name="ugender" <?php echo ($row["gender"]=='M')?'checked':'' ?> value="M" id="gender" readonly >
                                Female:<input type="radio"  name="ugender"<?php echo ($row["gender"]=='F')?'checked':'' ?> value="F" id="gender" readonly>
								EMAIL: <input type="text" name="w3lSubect" value="<?php echo $row["email_id"]; ?>" class="contact-input" readonly/>
								PHONE NO.: <input type="text" name="w3lWebsite" value="<?php echo $row["phone_number"]; ?>" class="contact-input" readonly/>
								PINCODE: <input type="number" name="w3lWebsite" value="<?php echo $row["pincode"]; ?>" class="contact-input" readonly/>
                                ADDRESS: <textarea name="w3lMessage" value="" readonly><?php echo $row["address"]; ?></textarea>
							</div>
							<div class="form-input">
                                <a href="edit-profile.php" class="btn btn-style">EDIT PROFILE</a>
