  ...
  #w3lDemoBar.w3l-demo-bar .no-margin-bottom-mobile{
	...
	<div class="page-head_agile_info_w3l inner-checkout-page">
		<div class="container py-5">
			<h3 class="title-style text-white pt-5"><span>My Complaint</span> </h3>
			<ul class="w3_short pt-3 pb-5">
				<li>
					<a href="index.php" class="text-white">Home</a>
					<i class="fa fa-angle-right mx-2 text-white" aria-hidden="true"></i>
				</li>
				<li class="text-light">My Complaint</li>
			</ul>
		</div>
	</div>
	<!-- //banner-2 -->
	...
	<div class="privacy py-5">
		<div class="container py-md-5 py-4">
			<div class="checkout-right">
				<h4 class="mb-sm-4 mb-3">Your complaint 
				...
				<div class="table-responsive">
					<table class="timetable_sub">
						...
						<tbody>
                            ...
                            $no = 1;
                            $grandtotal = 0;
                            $q = mysqli_query($connection,"SELECT * FROM tbl_complaint where user_id='{$uid}'");
                            while($row = mysqli_fetch_array($q))
                            {
                              echo "<tr>";
							 echo "<td>{$row['complaint_id']}</td>";
							 echo "<td>{$row['complaint_date_time']}</td>";
